...
| **MexiGo** | Projet BTS : site vitrine d'une agence de voyage au Mexique, multi-pages, en HTML / CSS / JavaScript | [site en ligne](https://olayode-ilerioluwa.github.io/Projet-Portfolio/mexigo/) · `PROJET_1 - Site_Vitrine/` |
| **Yuki** | Site vitrine d'un restaurant japonais : réservation en ligne, avis clients et interface d'administration. HTML / CSS / JavaScript et Firebase | [site en ligne](https://olayode-ilerioluwa.github.io/Projet-Portfolio/yuki/) · `Site_Yuki/` |
